<!DOCTYPE html>
  ...
  <head>
    ...
    {!!Html::style('https://cdn.datatables.net/v/bs-3.3.6/jq-2.2.3/dt-1.10.12/fc-3.2.2/fh-3.1.2/sc-1.4.2/datatables.min.css')!!}
...
{!!Html::script('https://cdn.datatables.net/v/bs-3.3.6/jq-2.2.3/dt-1.10.12/fc-3.2.2/fh-3.1.2/sc-1.4.2/datatables.min.js')!!}
